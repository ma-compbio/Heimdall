...
class HeimdallTrainer:
    ...
    def validate_model(self, dataloader, dataset_type):
        ...
        # gather across GPUs so rank-0 has the full vectors
        y_true_all = self.accelerator.gather_for_metrics(y_true_all)
        preds_all  = self.accelerator.gather_for_metrics(preds_all)
